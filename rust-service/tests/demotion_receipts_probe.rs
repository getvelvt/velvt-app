...
use velvt_shared_types::{
    ...
    RequestInterventionExplanation, RequestWeeklyDigest, ServerMessage, WorkBlockCoverage,
    WorkBlockIntensity, WorkBlockNextAction, WorkBlockPhase, WorkBlockResult,
};
...
async fn digest_counts_match_stored_aggregates_exactly() {
    ...
    // Ground truth.
    assert_eq!(digest.blocks_declared, 5);
    assert_eq!(digest.blocks_completed, 3);
