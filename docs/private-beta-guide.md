...
4. Velvt begins local collection after Accessibility is granted. Open **Today**, enter an optional local intention, and choose **Start Work Block**; no account or notification permission is required for this first value.
